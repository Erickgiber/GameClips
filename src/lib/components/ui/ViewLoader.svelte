...
<section class="boder-red-200 relative flex w-full justify-center pt-24">
	<article class="h-max w-max">
		<div id="ghost">
			<div id="red">
				<div id="pupil"></div>
				<div id="pupil1"></div>
		...
		<div class="mt-4 text-center text-2xl font-bold text-gray-500">
			{m.loading()}
		</div>
	</article>
</section>
