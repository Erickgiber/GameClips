					...
					<div class="grid gap-3 sm:grid-cols-2">
						<div class="rounded-2xl border border-white/10 bg-background/60 p-4">
							...
							<p class="text-sm text-muted-foreground">
								New recommendations, tags and game categories will surface here.
							</p>
						</div>
						<div class="rounded-2xl border border-white/10 bg-background/60 p-4">
							<div class="mb-3 flex items-center gap-2 text-sm font-semibold text-foreground">
								<TrendingUp class="h-4 w-4 text-secondary" />
								Live trends
							</div>
							<p class="text-sm text-muted-foreground">
								The most watched clips and rising games will be grouped into this module.
							</p>
						</div>
					</div>
				</div>
